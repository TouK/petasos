...
import { Link as RouterLink, matchPath, PathMatch, useLocation } from "react-router-dom";
...
const displayNameGet = (matchers: Record<string, (match: PathMatch) => ReactNode>) => (to: string) => {
