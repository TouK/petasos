import { Table, TableBody, TableCell, TableContainer, TableRow, Typography, TypographyProps } from "@mui/material";
import React, { ReactNode } from "react";
import { InfoPopover } from "./InfoPopover";
import { LinePlaceholder } from "./linePlaceholder";

const TBody = ({ properties, ...props }: { properties: PropertiesTableRow[] } & Pick<TypographyProps, "color">) => (
    <TableBody>
...
export const PropertiesTable = ({
    ...
    <TableContainer>
        ...
        >
            ...
            {!!advancedProperties?.length && <TBody properties={advancedProperties} color="warning.dark" />}
        </Table>
    </TableContainer>
);

export const createRow = (name: string, value: ReactNode, info: string = undefined): PropertiesTableRow => {
    return {
        name,
