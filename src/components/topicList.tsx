                                ...
                                <CardContent>
                                    <div className={topicBarStyles.Topic}>
                                        <div className={topicBarStyles.TopicColumn}>
                                            <div
                                                className={topicBarStyles.TopicName}>
                                                {topic}
                                            </div>
                                            <TopicFrontendUrl topic={topic} />
                                        </div>
                                        <div
                                            className={topicBarStyles.TopicColumnRight}>
                                            <SubscriptionsCounter
                                                topic={topics.topicsMap.get(topic)} />
                                            <IconButton size="small" color="primary"
                                                        onClick={() => topics.changeSelectedTopic(
                                                            topic)}><NavigateNext /></IconButton>
                                        </div>
                                    </div>
                                </CardContent>
                            </StyledTopicCard>)}
                ...
                {topicsList.length === 0
                    ...
                    <div className={styles.LayoutBodyContent}>
                        ...
                        <div className={layout.LayoutBodyContentInfo}>
                            No topics
                            yet{groups.selectedGroup && ` in group ${groups.selectedGroup}`}.
                        </div>
                    </div>
                    :
                    <>
                        <div className={styles.LayoutBodyContent}>
                            <div className={layout.LayerSectionHeader}>Topics
                            </div>
                            <TopicsSublist
