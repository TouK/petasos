...
export const SubscriptionInfo = {
    deliveryType: "Maximum rate defined by user (per data center). Maximum rate calculated by algorithm can be observed in \"Output rate\" metric.",
    ...
    metrics: {
        ...
        outputRate: "Maximum sending rate calculated based on receiving service performance. For well-performing service output rate should be equal to rate limit."
    },
    subscriptionPolicy: {
        ...
        sendingDelay: "Amount of time in ms after which an event will be send. Useful if events from two topics are sent at the same time and you want to increase chance that events from one topic will be deliver after events from other topic.",
        messageTtl: "Amount of time a message can be held in sending queue and retried. If message will not be delivered during this time, it will be discarded.",
