...
export const SubscriptionInfo = {
  ...
  metrics: {
    latency:
      "Latency of acknowledging messages by subscribing service as measured by Hermes.",
  ...
  subscriptionPolicy: {
    ...
    retryClientErrors:
      "If false, message will not be retried when service responds with 4xx status (i.e. Bad Request).",
    messageBackoff:
...
export const TopicInfo = {
  retentionTime: {
    duration:
      "For how many days message is available for subscribers after being published.",
  },
